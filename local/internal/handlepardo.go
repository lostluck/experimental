...
func (h *pardo) PrepareTransform(tid string, t *pipepb.PTransform, comps *pipepb.Components) (*pipepb.Components, []string) {
	...
	// This is because for ParDos, how they are handled, and what kinds of transforms are in and around the ParDo, the actual
	// shape of the graph will change.
	...
	// So alway, we need to first unmarshal the payload.
